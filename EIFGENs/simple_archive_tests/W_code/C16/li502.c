...
extern EIF_TYPED_VALUE F502_1002(EIF_REFERENCE);
extern void F502_1003(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F502_1004(EIF_REFERENCE);
...
/* {LINKABLE}.right */
EIF_TYPED_VALUE F502_1002 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {LINKABLE}.put_right */
void F502_1003 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 501, Current, 0, 1, 1045);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(501, Current, 1045);
	RTCC(arg1, 501, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 963, 0xF80001F5, 0); /* right */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
void F502_1004 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 501, Current, 0, 0, 1046);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(501, Current, 1046);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 963, 0xF80001F5, 0); /* right */
