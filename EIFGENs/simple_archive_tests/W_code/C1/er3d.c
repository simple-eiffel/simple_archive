...
static const EIF_TYPE_INDEX egt_0_3 [] = {0xFF01,281,0xFFFF};
static const EIF_TYPE_INDEX egt_1_3 [] = {0xFF01,307,2,0xFFFF};
...
static const EIF_TYPE_INDEX egt_9_3 [] = {0xFF01,281,0xFFFF};
static const EIF_TYPE_INDEX egt_10_3 [] = {0xFF01,281,0xFFFF};
static const EIF_TYPE_INDEX egt_11_3 [] = {0xFF01,20,0xFFFF};
static const EIF_TYPE_INDEX egt_12_3 [] = {0xFF01,2,0xFFFF};
static const EIF_TYPE_INDEX egt_13_3 [] = {0xFF01,276,0xFFFF};
static const EIF_TYPE_INDEX egt_14_3 [] = {0xFF01,284,0xFFFF};
...
static const struct desc_info desc_3[] = {
	...
	{EIF_GENERIC(egt_13_3), 45, 0},
	{EIF_NON_GENERIC(0x05 /*2*/), 46, 8},
	{EIF_GENERIC(egt_14_3), 47, 0xFFFFFFFF},
};
void Init3(void)
{
	IDSC(desc_3, 0, 2);
