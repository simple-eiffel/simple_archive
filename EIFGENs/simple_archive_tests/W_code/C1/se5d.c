...
static const EIF_TYPE_INDEX egt_0_5 [] = {0xFF01,281,0xFFFF};
static const EIF_TYPE_INDEX egt_1_5 [] = {0xFF01,307,4,0xFFFF};
...
static const EIF_TYPE_INDEX egt_9_5 [] = {0xFF01,281,0xFFFF};
static const EIF_TYPE_INDEX egt_10_5 [] = {0xFF01,281,0xFFFF};
...
static const struct desc_info desc_5[] = {
	...
	{EIF_NON_GENERIC(0x01F5 /*250*/), 50, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01F5 /*250*/), 48, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01F5 /*250*/), 49, 0xFFFFFFFF},
};
void Init5(void)
{
	IDSC(desc_5, 0, 4);
	IDSC(desc_5 + 1, 4, 4);
	IDSC(desc_5 + 32, 292, 4);
}
