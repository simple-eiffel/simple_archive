...
{
	GTCX
	RTOTC (F29_696,766,RTMS_EX_H("English",7,257590376));
}
...
{
	GTCX
	RTOTC (F29_701,771,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F29_702,772,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F29_703,773,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
