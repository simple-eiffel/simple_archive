...
#define Result RTOTRB(EIF_CHARACTER_8)
	RTOTDB(EIF_CHARACTER_8, F21_390);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 20, Current, 0, 0, 396);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(392, dtype))(Current)).it_c1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 20, Current, 0, 0, 397);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F21_396 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 20, Current, 0, 0, 402);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
