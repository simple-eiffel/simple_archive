...
extern EIF_TYPED_VALUE F333_3632(EIF_REFERENCE);
extern void F333_3635(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {BILINEAR}.off */
EIF_TYPED_VALUE F333_3632 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 332, Current, 0, 0, 4817);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(332, Current, 4817);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BILINEAR}.search */
void F333_3635 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 332, Current, 0, 1, 4818);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(332, Current, 4818);
	RTCC(arg1, 332, l_feature_name, 1, RTWCT(3121, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3137, dtype))(Current)).it_b);
	...
	RTHOOK(3);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(3129, 311))(Current, ur1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
