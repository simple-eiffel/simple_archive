...
extern void F926_3657(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F926_3657 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu2_1 uu2_1x.it_n2
	...
	RTEAA(l_feature_name, 925, Current, 0, 1, 4924);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(925, Current, 4924);
	RTIV(Current, RTAL);
