/*
 * Code for class DYNAMIC_CIRCULAR [G#1]
 */
...
extern EIF_TYPED_VALUE F939_4282(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {DYNAMIC_CIRCULAR}.duplicate */
EIF_TYPED_VALUE F939_4282 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 938, Current, 3, 1, 7086);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(938, Current, 7086);
	RTIV(Current, RTAL);
