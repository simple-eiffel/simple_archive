...
extern EIF_TYPED_VALUE F937_3649(EIF_REFERENCE);
...
EIF_TYPED_VALUE F937_3649 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 936, Current, 0, 0, 4907);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(936, Current, 4907);
	RTIV(Current, RTAL);
	RTHOOK(1);
