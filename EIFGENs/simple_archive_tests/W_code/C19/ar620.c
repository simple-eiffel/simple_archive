...
extern void F620_4808(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F620_4809(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F620_4810(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F620_4811(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F620_4812(EIF_REFERENCE);
extern EIF_TYPED_VALUE F620_4813(EIF_REFERENCE);
...
void F620_4808 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 619, Current, 1, 1, 10119);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(619, Current, 10119);
	{
		...
		RTCC(arg1, 619, l_feature_name, 1, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
...
void F620_4809 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 619, Current, 0, 1, 10120);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(619, Current, 10120);
	RTCC(arg1, 619, l_feature_name, 1, RTWCT(3157, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
...
/* {ARRAYED_STACK}.put */
void F620_4810 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 619, Current, 0, 1, 10121);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(619, Current, 10121);
	RTCC(arg1, 619, l_feature_name, 1, RTWCT(3157, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
...
/* {ARRAYED_STACK}.force */
void F620_4811 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 619, Current, 0, 1, 10122);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(619, Current, 10122);
	RTCC(arg1, 619, l_feature_name, 1, RTWCT(3157, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F620_4812 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 619, Current, 0, 0, 10123);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(619, Current, 10123);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F620_4813 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 619, Current, 1, 0, 10124);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(619, Current, 10124);
	RTIV(Current, RTAL);
	RTHOOK(1);
