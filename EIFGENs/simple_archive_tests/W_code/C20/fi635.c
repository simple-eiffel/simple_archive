...
extern EIF_TYPED_VALUE F635_3703(EIF_REFERENCE);
extern void F635_7342(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F635_3703 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 634, Current, 0, 0, 5020);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(634, Current, 5020);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F635_7342 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 634, Current, 0, 7341);
	RTSA(dtype);
	RTME(dtype, 0);
