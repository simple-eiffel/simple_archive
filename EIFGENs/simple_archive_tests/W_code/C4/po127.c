...
extern EIF_TYPED_VALUE F127_1618(EIF_REFERENCE);
...
EIF_TYPED_VALUE F127_1617 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 126, Current, 0, 0, 1635);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(126, Current, 1635);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1554, 134))(Current)).it_i4);
...
RTOID (F127_1618)
EIF_TYPED_VALUE F127_1618 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 126, Current, 0, 0, 1636);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(126, Current, 1636);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
