...
extern void F110_1581(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F110_1579 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 109, Current, 0, 0, 1599);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(109, Current, 1599);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(1461, dtype));
	ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1565, 134))(Current)).it_i4);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 109, Current, 0, 0, 1600);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(109, Current, 1600);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F110_1581 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 109, Current, 0, 1, 1597);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
