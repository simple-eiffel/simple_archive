...
extern EIF_TYPED_VALUE F221_4516(EIF_REFERENCE);
extern void F221_7361(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F221_4516 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 220, Current, 0, 0, 7510);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(220, Current, 7510);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F221_7361 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 220, Current, 0, 7360);
	RTSA(dtype);
	RTME(dtype, 0);
