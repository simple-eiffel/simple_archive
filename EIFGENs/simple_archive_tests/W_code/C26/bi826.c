...
extern EIF_TYPED_VALUE F826_3632(EIF_REFERENCE);
extern void F826_3635(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F826_7339(EIF_REFERENCE, int);
...
/* {BILINEAR}.off */
EIF_TYPED_VALUE F826_3632 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 825, Current, 0, 0, 4850);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(825, Current, 4850);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BILINEAR}.search */
void F826_3635 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui2_1 ui2_1x.it_i2
	...
	RTEAA(l_feature_name, 825, Current, 0, 1, 4851);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(825, Current, 4851);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(3137, dtype))(Current)).it_b);
	...
	RTHOOK(3);
	ui2_1 = arg1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(3129, 803))(Current, ui2_1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
/* {BILINEAR}._invariant */
void F826_7339 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 825, Current, 0, 7338);
	RTSA(dtype);
	RTME(dtype, 0);
