...
extern EIF_TYPED_VALUE F879_3703(EIF_REFERENCE);
extern void F879_7342(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F879_3703 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 878, Current, 0, 0, 5032);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(878, Current, 5032);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F879_7342 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 878, Current, 0, 7341);
	RTSA(dtype);
	RTME(dtype, 0);
