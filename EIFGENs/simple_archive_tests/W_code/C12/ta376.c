...
extern void F376_3657(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F376_3657 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 375, Current, 0, 1, 4909);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(375, Current, 4909);
	RTCC(arg1, 375, l_feature_name, 1, RTWCT(3018, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
