...
extern EIF_TYPED_VALUE F61_1165(EIF_REFERENCE);
extern EIF_TYPED_VALUE F61_1166(EIF_REFERENCE);
extern EIF_TYPED_VALUE F61_1167(EIF_REFERENCE);
...
EIF_TYPED_VALUE F61_1165 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F61_1166 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F61_1167 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 60, Current, 0, 0, 1196);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(60, Current, 1196);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(1069, "fractional_second", tr1));
