...
extern EIF_TYPED_VALUE F55_1101(EIF_REFERENCE);
extern EIF_TYPED_VALUE F55_1102(EIF_REFERENCE);
extern EIF_TYPED_VALUE F55_1103(EIF_REFERENCE);
extern EIF_TYPED_VALUE F55_1104(EIF_REFERENCE);
...
EIF_TYPED_VALUE F55_1101 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F55_1102 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F55_1104 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = (EIF_INTEGER_32) ((EIF_INTEGER_32) 60L);
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 54, Current, 0, 0, 1152);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(54, Current, 1152);
	RTIV(Current, RTAL);
	RTHOOK(1);
